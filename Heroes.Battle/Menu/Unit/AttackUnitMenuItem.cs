...
public class AttackUnitMenuItem : IMenuItem
{
    ...
    public AttackUnitMenuItem(TurnInformation turn, IMenuFactory menuFactory, IMenuBreaker menuBreaker, IUserInteraction userInteraction)
    {
        _turn = turn;
    ...
    public void Select()
    {
        ...
        _menu = _menuFactory
            .CreateMenu(menuBreaker, _turn,
                enemies
                .Select<IUnit, IMenuItem>(x => new AttackSelectionUnitMenuItem(x, _turn.ActiveUnit, _menuBreaker, _userInteraction))
